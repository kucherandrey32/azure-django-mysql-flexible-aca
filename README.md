...
- azure-mysql
urlFragment: azure-django-mysql-flexible-aca
name: Deploy Django Application with MySQL on Azure Container Apps (Python)
...
# Deploy Django Application with MySQL via Azure Container Apps
